...
// Versão de PRODUÇÃO (gravada nas plaquinhas após o teste rápido).
// Snapshot do commit 6ecc26b — FAST_TEST_MODE=false, 4 envios/hora, sequência JC Vital.
// O sketch de teste rápido está em sketch_may25a_copy_20260609103303/.
