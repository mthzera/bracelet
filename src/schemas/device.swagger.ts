...
export const getDevicesRouteSchema = {
  ...
  description:
    "Returns the 4 configured bracelets (3 pacientes reais + Rubens Prospero Menezes). patient/label/deviceMac são fixos; battery, mergedHealth, online e lastSeenAt vêm dos pacotes reais no banco.",
  response: {
    200: {
